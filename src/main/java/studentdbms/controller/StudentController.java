...
public class StudentController {
	...
	public String searchStudents(@RequestParam("keyword") String keyword, Model model) {
		...
		if (students.size() == 1) {
			return "redirect:/students/" + students.get(0).getId();
		}
	...
	public String updateStudent(@ModelAttribute("student") Student student) {
		studentService.saveOrUpdateStudent(student); // Save the updated student details
		return "redirect:/students/" + student.getId(); // Redirect to the updated student details page
	}
	...
	public String getStudentDetails(@PathVariable("id") int id, Model model) {
		...
		model.addAttribute("student", student);
		return "student-details"; // This should match the name of your Thymeleaf template for student details
	}
